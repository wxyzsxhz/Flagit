...
router.post("/", requireAuth(), dailyKarmaTouch(), validate(schemas.createPost), ctrl.create);
router.delete("/:id", requireAuth(), ctrl.remove);
router.post("/:id/vote", requireAuth(), dailyKarmaTouch(), validate(schemas.vote), ctrl.castVote);
router.post("/:id/report", requireAuth(), validate(schemas.report), ctrl.report);
