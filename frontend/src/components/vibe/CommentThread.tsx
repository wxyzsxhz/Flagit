...
function CommentNode({
  ...
  const vibe = useVibe();
  const currentUser = vibe.currentUser;
  const editComment = vibe.editComment;
  const deleteComment = vibe.deleteComment;
  const toggleReaction = vibe.toggleReaction;
  const reportContent = vibe.reportContent;

  // Explicitly override the context's type locally to resolve TS2339
  const addComment = vibe.addComment as (
      postId: string,
      content: string,
                ...
                <>
                  ...
                  <AlertDialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
                    <AlertDialogTrigger asChild>
                      <button className="flex items-center gap-1 rounded-full px-2 py-1 text-muted-foreground hover:bg-muted hover:text-destructive">
                    ...
                    <AlertDialogContent>
                      <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                          ...
                          comment and remove its data from our servers.
                        </AlertDialogDescription>
                      </AlertDialogHeader>
                      <AlertDialogFooter>
            ...
            <div className="mb-5 flex gap-3">
              ...
              <div className="flex-1 space-y-2">
                ...
                <div className="flex justify-end">
                  <Button size="sm" onClick={submit} className="gradient-brand text-white">Comment</Button>
                </div>
              </div>
            </div>
        ) : null}
