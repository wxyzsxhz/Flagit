...
function LoginPage() {
  const { login, currentUser, loading } = useVibe();
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="mx-auto flex max-w-md flex-col items-center px-4 py-8">
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Log in to share the flags.
        </p>

        <form
          onSubmit={submit}
          className="mt-8 w-full space-y-4 rounded-md border border-border bg-card p-6 shadow-soft"
        >
          ...
          <div className="space-y-1.5">
            ...
            <p className="text-xs text-muted-foreground">
              Demo: <code>midnight_owl</code> / <code>password</code>
            </p>
          </div>
